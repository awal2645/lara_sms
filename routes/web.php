...
Route::post('student-fees',[PaymentController::class,'searchStudentByFess'])->name('search.student.fees');
Route::post('student/payment',[PaymentController::class,'addStudentPayment'])->name('student.payment');
// PDF
