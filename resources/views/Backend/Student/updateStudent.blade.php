                      ...
                      <div class="row">
                        <div class="col-6">
                            <div class="form-group ">
                                <label for="up_stu_admitted_year" class="col-sm-12 col-form-label">Student Admit Year:</label>
                                <input type="text" name="up_stu_admitted_year" class="form-control" id="up_stu_admitted_year"
                                    placeholder="Enter Year " required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="up_stu_address" class="col-sm-12 col-form-label">Student Address:</label>
