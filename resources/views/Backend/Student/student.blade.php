                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-3">
                                ...
                                <select id="stu_class_id" data-url="{{ route('search.fees') }}" name="stu_class_id"
                            ...
                            <div class="form-group col-3">
                                ...
                                <select id="stu_section" name="stu_section" class="form-control"
                            ...
                            <div class="form-group col-3">
                                ...
                                <input type="number" name="class_fees" class="form-control" id="class_fees" value=""
                                    readonly>
                                <label for="stu_blood" class="col-sm-12 col-form-label"> Student Blood Group:</label>
                                <select id="stu_blood" name="stu_blood" class="form-control"
                                    aria-label="Default select example" required>
                            ...
                            <div class="form-group col-3">
                                <label for="stu_adm_roll" class="col-sm-12 col-form-label"> Student Admission Roll<span
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group ">
                                    <label for="stu_parents" class="col-sm-12 col-form-label">Student Parents
                                        Name:</label>
                                    <input type="text" name="stu_parents" class="form-control" id="stu_parents"
                                        placeholder="Enter Parents " required>
                                    <label for="stu_admitted_year" class="col-sm-12 col-form-label">Student Admit
                                        Year:</label>
                                    <input type="text" name="stu_admitted_year" class="form-control"
                                        id="stu_admitted_year" placeholder="Enter Year " value="<?php echo date('Y'); ?>"
                                        required>
                                    <label for="stu_pay_date" class="col-sm-12 col-form-label">Due Fees Payment Date
                                        :</label>
                                    <input type="date" name="stu_pay_date" class="form-control" id="stu_pay_date"
                                        value="" required>
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="form-group ">
                                    ...
                                    <br>
                                    <input class=" form-control btn btn-secondary" name="stu_img" type="file"
                                        id="stu_img">
                                    <br>
