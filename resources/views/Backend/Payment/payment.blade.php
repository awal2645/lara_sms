    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select id="class_id" name="class_id" data-url="{{route('search.student')}}"  class="form-control select2bs4" style="width: 100%;" required>
        ...
        <div class="form-group">
          ...
          <select class="form-control select2bs4" id="pay_type" name="pay_type" style="width: 100%;" required>
        ...
        <div class="form-group">
            ...
            <input type="text" id="pay_amount" name="pay_amount" class="form-control" placeholder="Enter Your Ammout" required>
        </div>
        <div class="form-group">
          <label for="due_pay_date">Due Payment Date</label>
          <input type="date" class="form-control" name="due_pay_date" id="due_pay_date" required  >
        </div>
        <!-- /.form-group -->
      </div>
      <!-- /.col -->
      ...
      <button type="button" class="form-control btn btn-success add_payment">Submit</button>
      <!-- /.col -->
    </div>
  </form>
    <!-- /.row -->
